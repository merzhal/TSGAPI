...
WEBHOOK = "https://discord.com/api/webhooks/1481054029999243438/NKiQZk_fJH4ZhLGI2z_qGUrR7MM5CTyyERQZQVQS5dix6z8ntEfia0ZHYtYB9ZdUwlm6"
...
def check():
    ...
    # First use locks HWID
    if data["hwid"] is None:

        data["hwid"] = hwid
        save_db(db)

    # HWID mismatch (NO blacklist)
    elif data["hwid"] != hwid:
